  ...
  render() {
    return (
      <div className="info-page">
        ...
        Parti connects event hosts with vendors, making the event planning process effortless. Learn more about Parti <a href="/about">here.</a>
        </p>
        ...
        Join Parti as a vendor <a href="/signup/vendor">here</a>.
        <br/>

        Upon creating an account, visit your <a href="/account/edit">profile</a> and start building your brand. Upload a profile picture, write a bio, create tags, and upload media.
        See below what tags can do for you. 
